    ...
    <div class="panel">
        ...
        <div class="table-responsive">
            ...
            <v-table v-if="!editMode">
                ...
                <tbody>
                    <tr v-for="(detailVal, idx) in selectedRow.externalIntegrationClientIds" :key="detailVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">{{ detailVal.clientId }}</td>
                        <td class="whitespace-nowrap">
                            <Type v-model="detailVal.type" :editMode="editMode"/>
                        </td>
                        <td class="whitespace-nowrap">
            ...
            <v-table v-else>
                ...
                <tbody>
                    <tr v-for="(addVal, idx) in newValue" :key="addVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">
                            <Number style="margin-left: -5px; width: 150px;" :editMode="editMode" v-model="addVal.clientId"/>
                        </td>
                        <td class="whitespace-nowrap">
                            <Type v-model="addVal.type" :editMode="editMode"/>
                        </td>
                    </tr>
                </tbody>
            </v-table>
